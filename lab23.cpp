...
ComplexNumber ComplexNumber::operator/(const ComplexNumber &c){
	return ComplexNumber(((real*c.real)+(imag*c.imag))/((c.real*c.real)+(c.imag*c.imag)),((c.real*imag)-(real*c.imag))/((c.real*c.real)+(c.imag*c.imag)));
}

ComplexNumber operator/(double a,const ComplexNumber &c){
	return ComplexNumber((a*c.real)/((c.real*c.real)+(c.imag*c.imag)),-(a*c.imag)/((c.real*c.real)+(c.imag*c.imag)));
}
...
double ComplexNumber::abs(){
	double abscomp = sqrt(real*real + imag*imag);
	return abscomp;
}
